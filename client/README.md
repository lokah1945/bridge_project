...
This package is the automation engine and gateway for the Bridge-Project. It runs on Linux and exposes an OpenAI-compatible API over HTTP.
...
- `browser_manager.py` — Playwright lifecycle, stealth, and one-fresh-context-per-request isolation.
